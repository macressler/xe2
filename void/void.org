...
** TODO Remove old bubble when emoting again, or move it upwards like a terminal.
** TODO Allow clear bubbles with a line to the left flush showing blocks  
** TODO bring narration back.
...
**** TODO [#C] Tiny thunder particle/sparks whenever cloud fragments glow
**** TODO [#C] Neon cloud pieces are irregular mostly-transparent pixel pngs that float along one another
**** DONE [#A] Nav points 
